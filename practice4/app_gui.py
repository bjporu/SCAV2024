...
class APIClientGUI(QMainWindow):
    ...
    def get_fields_for_endpoint(self, endpoint):
        ...
        placeholders_map = {
            ...
            "/resize/": ["/app/images/snoop_dogg.jpeg", "/app/images/resized.jpeg", "Width in pixels", "Height in pixels"],
            "/black_and_white/": ["/app/images/snoop_dogg.jpeg", "/app/images/blackandwhite.jpeg"],
            "/change_resolution/": ["/app/images/bbb.mp4", "/app/images/resolution.mp4", "New width", "New height"],
            "/change_chroma_subsampling/": ["/app/images/bbb.mp4",  "/app/images/chroma.mp4", "Pixel format (e.g., yuv420p)"],
            "/get_video_info/": ["/app/images/bbb.mp4"],
            "/create_bbb_container/": ["/app/images/bbb.mp4", "/app/images/"],
            "/video_tracks/": ["/app/images/bbb.mp4"],
            "/visualize_motion_vectors/": ["/app/images/bbb.mp4", "/app/images/motionvecs.mp4"],
            "/generate_yuv_histogram/": ["/app/images/bbb.mp4", "/app/images/yuvhist.mp4"],
            ...
            "/convert-video/": ["/app/images/bbb.mp4", "/app/images/", "Codec (e.g., h264)"],
            "/encoding-ladder/": [
                "/app/images/bbb.mp4",
                "/app/images/",
                '["vp8", "vp9"]',
